...
def model_opts():
	...
	# Load data path
	parser.add_argument("--train_data_file", type=str, default="D:\同步数据\训练数据\cross\\test_train_jd", help="Data source for training.")
	parser.add_argument("--dev_data_file",   type=str, default="D:\同步数据\训练数据\cross\\test_train_jd", help="Data source for validation.")
	parser.add_argument("--test_data_file",  type=str, default="D:\同步数据\训练数据\cross\\test_train_jd", help="Data source for testing.")
	parser.add_argument("--word_emb_file",   type=str, default="D:\同步数据\训练数据\\vocab\\jd_voc_w2v", help="Pre train embedding file.")
	parser.add_argument("--vocab_file",      type=str, default="D:\同步数据\训练数据\\vocab\\jd_vocab", help="Vocab model file.")
	parser.add_argument("--train_sim_file",  type=str, default="D:\同步数据\训练数据\cross\\test_train_sim_jd", help="Similar case files")
	parser.add_argument("--dev_sim_file",    type=str, default="D:\同步数据\训练数据\cross\\test_train_sim_jd", help="Similar case files")
	parser.add_argument("--test_sim_file",   type=str, default="D:\同步数据\训练数据\cross\\test_train_sim_jd", help="Similar case files")
	parser.add_argument("--data_file",       type=str, default="D:\同步数据\训练数据\cross\\test_jd.pkl", help="Data source for article classes.")
	parser.add_argument("--pre_file",        type=str, default="D:\同步数据\训练数据\can\pre_file", help="The file of the predict.")
	parser.add_argument("--gro_file",        type=str, default="D:\同步数据\训练数据\can\gro_file", help="The file of the groundtruth.")
	
	# Model select
	parser.add_argument("--use_role_embedding",  type=bool, default=True, help="Use role embedding or not  (default:True)")
	parser.add_argument("--use_knowledge_graph", type=bool, default=False, help="Use knowledge embedding or not True or False (default:True)")
	parser.add_argument("--use_cross_copy",      type=bool, default=False, help="Use cross copy or not True or False (default:True)")
	parser.add_argument("--use_cross_attention", type=bool, default=False, help="Use cross attention or not True or False (default:True)")
	parser.add_argument("--use_intent_enhance",  type=bool, default=False, help="Use intent enhance or not True or False (default:True)")
	parser.add_argument("--pointer_generate",    type=bool, default=False, help="use PGN or not")
	parser.add_argument("--coverage_mechanism",  type=bool, default=False, help="use coverage or not")
	parser.add_argument("--greedy_search",       type=bool, default=False, help="use greedy search or not")
	parser.add_argument("--beam_search",         type=bool, default=False, help="use beam search or not")
	...
	parser.add_argument("--use_merge",           type=bool, default=True, help="use merge or not")
	parser.add_argument("--use_pointer_loss",    type=bool, default=False, help="use merge or not")
	parser.add_argument("--use_copy_version",    type=int,  default=2,    help="use version : v1, v2 or v3")
	parser.add_argument("--hops",                type=int,  default=3,    help="the hop of memory network")
	...
	parser.add_argument("--vocab_size",         type=int, default=20001, help="Words in total in Vocab  (default: 160000)")
	parser.add_argument("--pointer_vsize",      type=int, default=20001, help="Words in total in Pointer Vocab  (default: 160000)")
	parser.add_argument("--pointer_vsize2",     type=int, default=20001, help="Words in total in Pointer Vocab  (default: 160000)")
	parser.add_argument("--emb_dense_size",     type=int, default=300,  help="Dimensionality of word embedding dense layer (default: 300)")
	
	# transformer used
	parser.add_argument("--transformer_layers",     type=int, default=4, help="Transformer layers (default: 4)")
	parser.add_argument("--sen_transformer_layers", type=int, default=1, help="Sentence Level Transformer layers (default: 1)")
	parser.add_argument("--heads",                  type=int, default=4, help="multi-head attention (default: 4)")
	...
	parser.add_argument("--max_decoder_steps",   type=int, default=100, help="max_decoder_steps (default: 100)")
	parser.add_argument("--max_path_length",     type=int, default=5, help="Max path sequence length (default: 5)")
	parser.add_argument("--max_sequence_length", type=int, default=15, help="Max sentence sequence length (default: 40)")
	parser.add_argument("--max_sentence_num",    type=int, default=30, help="Max sentence sequence length (default: 15)")
